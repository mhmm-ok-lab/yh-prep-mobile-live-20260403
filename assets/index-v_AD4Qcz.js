...
if (score >= 5) {
...
}`,options:[{id:"a",text:"Godkänd"},{id:"b",text:"Underkänd"},{id:"c",text:"5"},{id:"d",text:"Inget skrivs ut"}],answer_key:"a",explanation:"7 är större än eller lika med 5, så första grenen körs."},{id:"prog-10",track_id:"prog1a",topic:"Metoder",format:"short",difficulty:"Medel",source_tier:"Sekundär",estimated_minutes:5,prompt:"Förklara kort vad en metod gör i Java och ge ett enkelt exempel på vad den kan användas till.",answer_key:"En metod samlar kod som kan återanvändas. Exempel: en method som tar emot två tal och returnerar summan.",explanation:"Svar ska visa förståelse för återanvändning, input/return och ett konkret användningsfall."}],L=[{id:"mock-mini-5",name:"Mini-check 5 min (alla spår)",track_id:"nackademin_ux",total_minutes:5,sections:[{title:"UX-snabb",track_id:"nackademin_ux",topics:["Logik/analys","Problemlösning"],question_ids:["ux-1","ux-2"],minutes:2,weight:.34},{title:"IT-snabb",track_id:"iths_itsec",topics:["Dator- och nätverksteknik","Svenska/Engelska/Matte"],question_ids:["it-1","core-1"],minutes:2,weight:.33},{title:"Prog-snabb",track_id:"prog1a",topics:["Variabler och datatyper"],question_ids:["prog-1"],minutes:1,weight:.33}],scoring_rules:"Snabb nulägeskoll. Kort mix av UX, IT och Programmering 1/A."},{id:"mock-nack-60",name:"Nackademin-liknande 60 min",track_id:"nackademin_ux",total_minutes:60,sections:[{title:"Analys & logik",track_id:"nackademin_ux",topics:["Logik/analys","Problemlösning","Teststrategi","Scenario-övning"],question_ids:["ux-1","ux-2","ux-3","ux-4","ux-5","ux-6"],minutes:60,weight:1}],scoring_rules:"Poäng per korrekt svar. Korta svar bedöms mot modellförslag."},{id:"mock-iths-90",name:"IT-H Del 1+2 (90 min)",track_id:"iths_itsec",total_minutes:90,sections:[{title:"Del 1: Svenska/Engelska/Matte",track_id:"iths_itsec",topics:["Svenska/Engelska/Matte"],question_ids:["it-3","core-1"],minutes:20,weight:.2},{title:"Del 2: Dator- och nätverksteknik",track_id:"iths_itsec",topics:["Dator- och nätverksteknik"],question_ids:["it-1","it-2","it-4","it-5","it-6"],minutes:70,weight:.8}],scoring_rules:"Separat delpoäng, total viktad poäng enligt 20/80."},{id:"mock-prog-45",name:"Programmering 1/A delprov (45 min)",track_id:"prog1a",total_minutes:45,sections:[{title:"Del 1: Grunder",track_id:"prog1a",topics:["Variabler och datatyper","Villkor"],question_ids:["prog-1","prog-2","prog-6"],minutes:15,weight:.33},{title:"Del 2: Flöde och läsning",track_id:"prog1a",topics:["Loopar","Code tracing"],question_ids:["prog-3","prog-7","prog-9"],minutes:15,weight:.33},{title:"Del 3: Metoder och felsökning",track_id:"prog1a",topics:["Metoder","Felsökning","Debugging-game"],question_ids:["prog-4","prog-5","prog-8","prog-10"],minutes:15,weight:.34}],scoring_rules:"Separat poäng per del, fokus på grunder först och tydlig återkoppling på feltyper."}],U=[{id:"ev-nack-1",provider:"Nackademin",url:"https://nackademin.se/antagning/urval-och-antagningsprov/",claim:"Urvalet omfattar antagningsprov med fokus på analys- och problemlösningsförmåga.",confidence:"Hög",source_tier:"Officiell",track_id:"nackademin_ux",last_verified_date:"2026-04-03"},{id:"ev-nack-2",provider:"Nackademin (EN)",url:"https://nackademin.se/en/admission/selection-entrance-exam/",claim:"Den engelska antagningssidan bekräftar att provet används för att bedöma lämplighet och förmåga att hantera programmens upplägg.",confidence:"Medel",source_tier:"Officiell",track_id:"nackademin_ux",last_verified_date:"2026-04-03"},{id:"ev-iths-1",provider:"IT-Högskolan",url:"https://www.iths.se/antagningsprovet/",claim:"Antagningsprovet består av två delar: allmän del och programspecifik del.",confidence:"Hög",source_tier:"Officiell",track_id:"iths_itsec",last_verified_date:"2026-04-03"},{id:"ev-iths-3",provider:"IT-Högskolan (FAQ/antagning)",url:"https://www.iths.se/vanliga-fragor/",claim:"IT-Högskolan hänvisar till att antagning och förberedande material kan variera, vilket gör det rimligt att träna både allmän del och programspecifik del separat.",confidence:"Medel",source_tier:"Officiell",track_id:"iths_itsec",last_verified_date:"2026-04-03"},{id:"ev-iths-2",provider:"IT-Högskolan",url:"https://www.iths.se/utbildningar/preparandkurs/",claim:"Förkunskapsspåret för IT-säkerhet lyfter dator- och nätverksteknik.",confidence:"Hög",source_tier:"Officiell",track_id:"iths_itsec",last_verified_date:"2026-04-03"},{id:"ev-prog-1",provider:"Linköpings kommun (Komvux-info)",url:"https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser",claim:"Prövning i programmering brukar innehålla praktiska moment, teori och uppgifter i flera delar.",confidence:"Medel",source_tier:"Sekundär",track_id:"prog1a",last_verified_date:"2026-04-03"},{id:"ev-prog-2",provider:"Komvux/exempel på prövning",url:"https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser",claim:"Prövning i gymnasiala kurser brukar kombinera teori med praktiska uppgifter, vilket passar ett programmeringsspår med både kunskapstest och kodläsning.",confidence:"Medel",source_tier:"Sekundär",track_id:"prog1a",last_verified_date:"2026-04-03"},{id:"ev-community-1",provider:"Community-sammanställning",url:"https://nackademin.se/en/admission/selection-entrance-exam/",claim:"Tidigare sökande beskriver tidsbrist som huvudutmaning; träningsmönster fokuserar därför på tidsatta övningar.",confidence:"Låg",source_tier:"Community",track_id:"nackademin_ux",last_verified_date:"2026-04-03"},{id:"ev-community-2",provider:"Community-sammanställning",url:"https://www.iths.se/antagningsprovet/",claim:"Tidigare sökande beskriver att del 1 ofta känns bred och att del 2 kräver fokus på nätverk, säkerhet och begrepp som brukar återkomma.",confidence:"Låg",source_tier:"Community",track_id:"iths_itsec",last_verified_date:"2026-04-03"},{id:"ev-community-3",provider:"Community-sammanställning",url:"https://www.linkoping.se/forskola-och-utbildning/vuxenutbildning/komvux/alla-skolor-inom-komvux-i-linkoping/linvux/provning/provning---gymnasiala-kurser",claim:"I programmeringsprövningar återkommer ofta uppgifter om variabler, villkor, loopar och felsökning snarare än enbart teori.",confidence:"Låg",source_tier:"Community",track_id:"prog1a",last_verified_date:"2026-04-03"}],_t=30,yt=45,Vt=1440*60*1e3,X=new Date(2026,3,7,9,0,0);function bt(e,t,r){return Math.min(r,Math.max(t,e))}function H(e){return e.reduce((t,r)=>t+r.minutes,0)}function B(e){return new Date(e.getFullYear(),e.getMonth(),e.getDate()).getTime()}function Ut(e=X){return new Intl.DateTimeFormat("sv-SE",{weekday:"long",day:"numeric",month:"long",year:"numeric"}).format(e)}function St(e=new Date,t=X){return Math.round((B(t)-B(e))/Vt)}function Ht(e=new Date,t=X){const r=St(e,t);return r<0?"Första provet är genomfört":r===0?"D-0 idag":`D-${r}`}function $t(e){const t=H(e);if(t>=_t&&t<=yt)return e;const r=bt(t,_t,yt),i=r/Math.max(t,1),n=e.map(o=>({...o,minutes:Math.max(3,Math.round(o.minutes*i))})),a=bt(r-H(n),-5,5);return a!==0&&(n[0]={...n[0],minutes:Math.max(3,n[0].minutes+a)}),n}function Mt(e=new Date,t=X){return B(e)<=B(t)?"A":"B"}function Bt(e){const t=St(e);return`Sprint A (${t<=0?"D-0: provdag":`D-${t} till D-0`}): Nackademin-prioritet`}function Kt(){return $t([{trackId:"nackademin_ux",topic:"Analys + problemlösning",minutes:25,mode:"Drill"},{trackId:"prog1a",topic:"Programmeringsgrunder (variabler/villkor/loopar)",minutes:7,mode:"Lär"},{trackId:"iths_itsec",topic:"Snabb engelska/matte-rep",minutes:3,mode:"Drill"}])}function Xt(){return $t([{trackId:"iths_itsec",topic:"Dator- och nätverksteknik",minutes:24,mode:"Drill"},{trackId:"prog1a",topic:"Kodövning + felsökning",minutes:10,mode:"Drill"},{trackId:"nackademin_ux",topic:"Teststrategi och tidsdisciplin",minutes:6,mode:"Lär"}])}function F(e=new Date){const t=Mt(e),r=t==="A"?Kt():Xt();return{sprint:t,title:t==="A"?Bt(e):"Sprint B (efter första provet): IT-H-prioritet",totalMinutes:H(r),blocks:r}}function Gt(e){const t=H(e)||1,r={nackademin_ux:0,iths_itsec:0,prog1a:0};for(const i of e)r[i.trackId]+=i.minutes;return{nackademin_ux:Math.round(r.nackademin_ux/t*100),iths_itsec:Math.round(r.iths_itsec/t*100),prog1a:Math.round(r.prog1a/t*100)}}function It(e=new Date){return Mt(e)==="A"?{id:"mock-nack-60",label:"Nackademin-liknande 60 min",minutes:60}:{id:"mock-iths-90",label:"IT-H Del 1+2 (90 min)",minutes:90}}function Pt(e,t){return e.filter(r=>!(t.trackId!=="all"&&r.track_id!==t.trackId||t.topic!=="all"&&r.topic!==t.topic||t.difficulty!=="all"&&r.difficulty!==t.difficulty||t.sourceTier!=="all"&&r.source_tier!==t.sourceTier))}function C(e){const t=e.reduce((r,i)=>r+i.estimated_minutes,0);return Math.min(45,Math.max(15,t))}function ot(e,t){let r=0;const i=new Map;for(const c of e){const u=(t[c.id]||"").trim().toLowerCase(),p=c.answer_key.trim().toLowerCase();if(c.format==="mcq"?u===p:u.length>0&&p.includes(u.slice(0,8))){r+=1;continue}i.set(c.topic,(i.get(c.topic)||0)+1)}const n=e.length,a=n>0?Math.round(r/n*100):0,o=[...i.entries()].sort((c,u)=>u[1]-c[1]).map(([c])=>c).slice(0,3);return{correct:r,total:n,scorePercent:a,weakTopics:o}}const pt="yh.study-sessions",q="yh.active-session",Yt=1;let ct="default";function Tt(e,t){if(!e)return t;try{return JSON.parse(e)}catch{return t}}function w(e){return`${e}.${ct}`}function Jt(e){return e.trim().toLowerCase().replace(/[^a-z0-9_-]/g,"")||"default"}function Dt(e){return ct=Jt(e),ct}function mt(){return Tt(localStorage.getItem(w(pt)),[])}function Qt(e){const t=mt();t.unshift(e),localStorage.setItem(w(pt),JSON.stringify(t.slice(0,100)))}function G(){return Tt(localStorage.getItem(w(q)),null)}function A(e){localStorage.setItem(w(q),JSON.stringify(e))}function Lt(){localStorage.removeItem(w(q))}function zt(){return{version:Yt,exportedAt:new Date().toISOString(),studySessions:mt(),activeSession:G()}}function Wt(e){const t=Array.isArray(e.studySessions)?e.studySessions.slice(0,100):[];localStorage.setItem(w(pt),JSON.stringify(t));const r=!!e.activeSession&&typeof e.activeSession=="object";return r?localStorage.setItem(w(q),JSON.stringify(e.activeSession)):localStorage.removeItem(w(q)),{importedSessions:t.length,restoredActiveSession:r}}const At=document.querySelector("#app");if(!At)throw new Error("App container saknas");const Y=At,lt={overview:"Översikt",tracks:"Spår",bank:"Frågebank",mock:"Mockprov",research:"Research",logic:"Logik"},gt=new URLSearchParams(window.location.search),dt="yh.current-user-id",Zt="yh.study-profile";function J(e){return e.trim().toLowerCase().replace(/[^a-z0-9_-]/g,"")||"gäst"}function te(){const e=localStorage.getItem(dt)||"gäst",t=J(e);return localStorage.setItem(dt,t),t}function ee(e){const t=J(e);return localStorage.setItem(dt,t),t}function re(){return`user-${Math.random().toString(36).slice(2,7)}`}function ie(e){const t=J(e);if(t==="gäst")return"G";const r=t.split(/[-_]+/).filter(Boolean);return r.length>=2?`${r[0][0]||""}${r[1][0]||""}`.toUpperCase():t.slice(0,2).toUpperCase()||"G"}function Et(e){return`${Zt}.${J(e)}`}function Z(e){const t=ee(e);P=t,Dt(t),l=G(),f=qt(t),h=null,y&&(window.clearInterval(y),y=null),vt(),$(`Bytt till användare: ${t}`)}let E="overview",v={trackId:"all",topic:"all",difficulty:"all",sourceTier:"all"},P=te();Dt(P);let Q=It().id;const tt=gt.get("view");tt&&tt in lt&&(E=tt);const et=gt.get("track");et&&b.some(e=>e.id===et)&&(v={...v,trackId:et});const rt=gt.get("mock");rt&&L.some(e=>e.id===rt)&&(Q=rt);let l=G(),h=null,y=null,ft=navigator.onLine,K="";const ne=82,Nt=112;let I=null,N=0,O=!1,x=null,Ot="Designa en digital tjänst för IKEA som löser problemet: kunden vill boka upphämtning av returvaror.";const j={sessionPreference:[{id:"30",label:"30 min fokuspass (rekommenderat nu)"},{id:"45",label:"45 min standardpass"},{id:"60",label:"60 min när jag har energi"}],blocker:[{id:"time",label:"Tidsstress i prov"},{id:"logic",label:"Logik och resonemang"},{id:"network",label:"IT/nätverkstermer"},{id:"coding",label:"Kodförståelse/felsökning"},{id:"other",label:"Annat (skriv i fritext)"}],confidence:[{id:"low",label:"Låg - behöver tydlig guidning"},{id:"mid",label:"Medel - behöver mest träning"},{id:"high",label:"Hög - vill främst ha tidsprov"}],targetPriority:[{id:"nack",label:"Nackademin UX (akut)"},{id:"iths",label:"IT-H IT-säkerhet"},{id:"prog",label:"Programmering 1/A"}]};let f=qt();function S(e){return b.find(t=>t.id===e)?.name||e}function z(e){return`track-${e}`}function ae(e){const t=Math.max(0,Math.floor(e/1e3)),r=Math.floor(t/60).toString().padStart(2,"0"),i=(t%60).toString().padStart(2,"0");return`${r}:${i}`}function jt(e){return e.questionIds.map(t=>_.find(r=>r.id===t)).filter(Boolean)}function se(e){return e.reduce((t,r)=>t+r.duration_minutes,0)}function oe(e){const t={nackademin_ux:0,iths_itsec:0,prog1a:0};for(const i of e)t.nackademin_ux+=i.track_mix.nackademin_ux||0,t.iths_itsec+=i.track_mix.iths_itsec||0,t.prog1a+=i.track_mix.prog1a||0;const r=Math.max(1,e.length);return{nackademin_ux:Math.round(t.nackademin_ux/r),iths_itsec:Math.round(t.iths_itsec/r),prog1a:Math.round(t.prog1a/r)}}function Ct(){return _.filter(e=>["Logik/analys","Svenska/Engelska/Matte","Code tracing","Debugging-game"].includes(e.topic))}function ce(){const e=["IKEA","1177","SJ","Skatteverket","Foodora"],t=["användaren hittar inte status på sitt ärende","för många steg gör att användaren avbryter","det är otydligt vad som händer efter beställning","returer och ombokningar upplevs krångliga","supporten får för många repetitiva frågor"],r=e[Math.floor(Math.random()*e.length)],i=t[Math.floor(Math.random()*t.length)];return`Designa en digital tjänst för ${r} som löser problemet: ${i}.`}function it(){return{sessionPreference:"30",blocker:"time",confidence:"mid",targetPriority:"nack",notes:""}}function qt(e=P){try{const t=localStorage.getItem(Et(e));if(!t)return it();const r=JSON.parse(t);return{...it(),...r}}catch{return it()}}function le(e,t=P){localStorage.setItem(Et(t),JSON.stringify(e))}function de(e,t,r){const i=ot(t,r);if(!e)return{sectionResults:[],finalScore:i.scorePercent};const n=L.find(u=>u.id===e);if(!n)return{sectionResults:[],finalScore:i.scorePercent};const a=n.sections.map(u=>{const p=t.filter(M=>u.question_ids.includes(M.id)),g=ot(p,r);return{title:u.title,scorePercent:g.scorePercent,correct:g.correct,total:g.total,weight:u.weight}}),o=a.reduce((u,p)=>u+p.weight,0)||1,c=a.reduce((u,p)=>u+p.scorePercent*(p.weight/o),0);return{templateName:n.name,sectionResults:a,finalScore:Math.round(c)}}function nt(e,t){return j[e].find(r=>r.id===t)?.label||t}function kt(e){return e==="iths"?"iths_itsec":e==="prog"?"prog1a":"nackademin_ux"}function ue(e){return e==="nackademin_ux"?"Logik/analys":e==="iths_itsec"?"Dator- och nätverksteknik":"Loopar"}function ut(e){const t=_.filter(i=>i.topic===e);if(t.length===0)return"nackademin_ux";const r={nackademin_ux:0,iths_itsec:0,prog1a:0};for(const i of t)r[i.track_id]+=1;return Object.entries(r).sort((i,n)=>n[1]-i[1])[0]?.[0]||"nackademin_ux"}function pe(e){const t=kt(f.targetPriority),r=F().sprint,i={nackademin_ux:{minutes:0,avgScore:0,weight:0,weakHits:0,recentHeavy:0,score:0},iths_itsec:{minutes:0,avgScore:0,weight:0,weakHits:0,recentHeavy:0,score:0},prog1a:{minutes:0,avgScore:0,weight:0,weakHits:0,recentHeavy:0,score:0}},n=[...e].sort((d,s)=>+new Date(s.date)-+new Date(d.date));for(const d of e){for(const s of b.map(m=>m.id)){const m=d.track_mix[s],T=m/100;m<=0||(i[s].minutes+=Math.round(d.duration_minutes*T),i[s].avgScore+=d.score*T,i[s].weight+=T)}for(const s of d.weak_topics){const m=ut(s);i[m].weakHits+=1}}for(const d of b.map(s=>s.id)){const s=i[d];s.avgScore=s.weight>0?Math.round(s.avgScore/s.weight):0}const a=n.slice(0,2);for(const d of a){const s=Object.entries(d.track_mix).sort((m,T)=>T[1]-m[1])[0]?.[0]||"nackademin_ux";d.track_mix[s]>=60&&(i[s].recentHeavy+=1)}for(const d of b){const s=i[d.id];let m=0;d.id===t&&(m+=2.2),r==="A"&&d.id==="nackademin_ux"&&(m+=1.4),r==="B"&&d.id==="iths_itsec"&&(m+=1.4),s.minutes<20&&(m+=1.2),m+=s.weakHits*.75,m-=s.recentHeavy*1.1,s.avgScore>75&&s.minutes>80&&(m-=.6),s.score=m}const o=Object.entries(i).sort((d,s)=>s[1].score-d[1].score)[0]?.[0]||t,c=Object.entries(i).sort((d,s)=>s[1].score-d[1].score).map(([d])=>d).slice(0,b.length),p=n.flatMap(d=>d.weak_topics).filter(d=>ut(d)===o)[0]||ue(o),g=i[o].weakHits>=2||f.confidence==="low"?"Lär":"Drill",M=Math.max(25,Math.min(45,Number.parseInt(f.sessionPreference,10)||35)),W=_.filter(d=>d.track_id===o).sort((d,s)=>{const m=d.topic===p?1:0;return(s.topic===p?1:0)-m}).slice(0,10).map(d=>d.id),V=`${S(o)} prioriteras nu (${i[o].weakHits} svaghetsträffar, senaste fokus balanseras).`;return{trackId:o,topic:p,mode:g,durationMinutes:M,questionIds:W,reason:V,ranking:c}}function me(e,t){return b.map(r=>{const i=e.reduce((p,g)=>p+Math.round(g.duration_minutes*(g.track_mix[r.id]||0)/100),0),n=e.reduce((p,g)=>p+g.score*((g.track_mix[r.id]||0)/100),0),a=e.reduce((p,g)=>p+(g.track_mix[r.id]||0)/100,0),o=a>0?Math.round(n/a):0,c=e.flatMap(p=>p.weak_topics).filter(p=>ut(p)===r.id).length;let u="in_progress";return i<15?u="not_started":c>=3||a>0&&o<55?u="needs_help":o>=75&&i>=80&&c<=1&&(u="near_ready"),{trackId:r.id,minutes:i,avgScore:o,weakHits:c,priority:t.trackId===r.id,stage:u}})}function ge(e){return e==="not_started"?"Ej startad":e==="needs_help"?"Mycket fel":e==="near_ready"?"Nära klar":"Påbörjad"}function fe(e){return e==="not_started"?"track-btn-not-started":e==="needs_help"?"track-btn-needs-help":e==="near_ready"?"track-btn-near-ready":"track-btn-in-progress"}function Ft(){const e=F(),t=[],r=kt(f.targetPriority),n={time:["Logik/analys","Problemlösning","Svenska/Engelska/Matte"],logic:["Logik/analys","Code tracing","Debugging-game"],network:["Dator- och nätverksteknik","Säkerhet och social engineering"],coding:["Loopar","Metoder","Felsökning","Code tracing","Debugging-game"],other:[]}[f.blocker]||[];for(const o of e.blocks){const c=_.filter(g=>g.track_id===o.trackId),u=o.minutes>=20?4:o.minutes>=10?3:2,p=c.slice(0,u);for(const g of p)t.find(M=>M.id===g.id)||t.push(g)}const a=_.filter(o=>o.track_id===r);for(const o of a)if(t.find(c=>c.id===o.id)||t.unshift(o),t.length>=12)break;if(n.length>0){const o=_.filter(c=>n.includes(c.topic));for(const c of o)if(t.find(u=>u.id===c.id)||t.push(c),t.length>=12)break}if(t.length<8){for(const o of _)if(t.find(c=>c.id===o.id)||t.push(o),t.length>=8)break}return t.slice(0,12)}function $(e){K=e,k(),window.setTimeout(()=>{K="",k()},3500)}function ke(){const e=zt(),t=new Blob([JSON.stringify(e,null,2)],{type:"application/json"}),r=URL.createObjectURL(t),i=document.createElement("a"),n=new Date().toISOString().replace(/[:.]/g,"-");i.href=r,i.download=`yh-prep-backup-${n}.json`,document.body.append(i),i.click(),i.remove(),URL.revokeObjectURL(r),$("Backup exporterat.")}async function ve(e){try{const t=await e.text(),r=JSON.parse(t),i=Wt(r);l=G(),$(`Import klar: ${i.importedSessions} pass, aktiv session ${i.restoredActiveSession?"återställd":"saknas"}.`)}catch{$("Import misslyckades. Kontrollera att filen är en giltig backup.")}}function he(){if(!("serviceWorker"in navigator))return;if(window.location.hostname.endsWith("github.io")){navigator.serviceWorker.getRegistrations().then(t=>Promise.all(t.map(r=>r.unregister()))).catch(()=>{}),"caches"in window&&caches.keys().then(t=>Promise.all(t.map(r=>caches.delete(r)))).catch(()=>{});return}navigator.serviceWorker.register("sw.js").catch(()=>{$("Kunde inte aktivera offline-läge.")})}function _e(e){return e instanceof Element?!!e.closest("input, textarea, select, button, a, summary, label"):!1}function Rt(){if(x)return x;const e=document.createElement("div");return e.className="pull-refresh-indicator",e.setAttribute("aria-hidden","true"),e.textContent="Dra ned för uppdatera",document.body.append(e),x=e,e}function at(e,t){const r=Rt(),i=Math.max(0,Math.min(Nt,e));r.style.opacity=i>0?"1":"0",r.style.transform=`translate(-50%, ${-50+i}px)`,r.classList.toggle("visible",i>0),r.classList.toggle("armed",t),r.textContent=t?"Släpp för att uppdatera":"Dra ned för uppdatera"}function xt(){I=null,N=0,O=!1,x&&(x.style.opacity="0",x.style.transform="translate(-50%, -50px)",x.classList.remove("visible","armed"),x.textContent="Dra ned för uppdatera")}function ye(){if(l){A(l),$("Uppdaterar sidan... aktivt pass autosparas."),window.setTimeout(()=>window.location.reload(),120);return}window.location.reload()}function be(){if(!("ontouchstart"in window))return;Rt(),window.addEventListener("touchstart",t=>{if(t.touches.length!==1){I=null;return}if(window.scrollY>0||_e(t.target)){I=null;return}I=t.touches[0].clientY,N=0,O=!1,at(0,!1)},{passive:!0}),window.addEventListener("touchmove",t=>{if(I===null||t.touches.length!==1)return;if(window.scrollY>0){xt();return}const r=t.touches[0].clientY-I;if(r<=0){at(0,!1);return}N=Math.min(Nt,r*.7),O=N>=ne,at(N,O),t.preventDefault()},{passive:!1});const e=()=>{if(I===null)return;const t=O;xt(),t&&ye()};window.addEventListener("touchend",e,{passive:!0}),window.addEventListener("touchcancel",e,{passive:!0})}function st(e){document.querySelectorAll("details.mini-menu[open]").forEach(r=>{(!e||r!==e)&&(r.open=!1)})}function xe(){document.addEventListener("toggle",e=>{const t=e.target;t instanceof HTMLDetailsElement&&t.matches("details.mini-menu")&&t.open&&st(t)},!0),document.addEventListener("click",e=>{const t=e.target;t instanceof Element&&(t.closest("details.mini-menu")||st())},!0),document.addEventListener("keydown",e=>{e.key==="Escape"&&st()})}function vt(){y&&(window.clearInterval(y),y=null),l&&(y=window.setInterval(()=>{if(l){if(Date.now()>=l.endsAt){ht(!0);return}k()}},1e3))}function we(e){if(e.length===0)return{nackademin_ux:0,iths_itsec:0,prog1a:0};const t={nackademin_ux:0,iths_itsec:0,prog1a:0};for(const r of e)t[r.track_id]+=1;return{nackademin_ux:Math.round(t.nackademin_ux/e.length*100),iths_itsec:Math.round(t.iths_itsec/e.length*100),prog1a:Math.round(t.prog1a/e.length*100)}}function D(e,t,r,i){t.length!==0&&(l={id:crypto.randomUUID(),mode:e,startedAt:Date.now(),endsAt:Date.now()+r*6e4,questionIds:t,currentIndex:0,answers:{},templateId:i},A(l),vt(),k())}function ht(e=!1){if(!l)return;const t=jt(l),r=ot(t,l.answers),i=de(l.templateId,t,l.answers),n=we(t),a=Math.max(1,Math.round((Date.now()-l.startedAt)/6e4));Qt({id:l.id,date:new Date().toISOString(),duration_minutes:a,mode:l.mode,track_mix:n,score:i.finalScore,weak_topics:r.weakTopics}),h={mode:l.mode,scorePercent:i.finalScore,correct:r.correct,total:r.total,weakTopics:r.weakTopics,autoSubmitted:e,sectionResults:i.sectionResults,templateName:i.templateName},l=null,Lt(),y&&(window.clearInterval(y),y=null),k()}function Se(){l=null,Lt(),y&&(window.clearInterval(y),y=null),k()}function wt(){const e=mt(),t=F(),r=Gt(t.blocks),i=oe(e),n=Ht(),a=Ut(),o=It(),c=Ft(),u=kt(f.targetPriority),p=S(u),g=Number.parseInt(f.sessionPreference,10)||t.totalMinutes,M=nt("blocker",f.blocker),R=pe(e),W=me(e,R),V=new Map(R.ranking.map((s,m)=>[s,m])),d=[...W].sort((s,m)=>(V.get(s.trackId)??99)-(V.get(m.trackId)??99));return`
    <div class="grid overview-grid">
      <section class="card critical-card span-12">
        <h3>Snabbstart idag</h3>
        <p class="muted">Status: ${ft?"Online":"Offline"} • ${t.totalMinutes} min</p>
        <div class="critical-kpis">
          <p><strong>Prov:</strong> ${n}</p>
          <p><strong>Nästa mock:</strong> ${o.minutes} min</p>
        </div>
        <p class="muted">Nu: ${p} • ${g} min • ${M}</p>
      ...
      <section class="card span-12">
        ...
        <div class="priority-strip">
          ${d.map(s=>`
                <button class="track-priority-btn ${fe(s.stage)} ${s.priority?"is-recommended":""}"
                  data-action="focus-priority-track" data-track="${s.trackId}">
                  <strong>${s.priority?"(R) ":""}${S(s.trackId)}</strong>
                  <span>${s.priority?R.mode:"Drill"} • ${ge(s.stage)} • ${s.avgScore}% • ${s.minutes} min</span>
                </button>
              `).join("")}
        </div>
      </section>
  ...
  `}function $e(){const e=["Logik/analys","Mattebas","Teststrategi","Programmeringsgrunder"];return`
    <div class="grid">
      ${b.map(t=>`
  ...
  `}function Me(){const e=Pt(_,v),t=Array.from(new Set(_.map(r=>r.topic))).sort();return`
    <div class="grid">
      <section class="card span-12">
        ...
        <div class="inline-controls">
          <select data-filter="trackId">
            ...
            ${b.map(r=>`<option value="${r.id}" ${v.trackId===r.id?"selected":""}>${r.name}</option>`).join("")}
          </select>
  ...
  `}function Ie(){const e=L.find(r=>r.id===Q)||L[0],t=e.sections.reduce((r,i)=>r+i.question_ids.length,0);return`
    <div class="grid">
      <section class="card span-12">
  ...
  `}function Pe(){const e=U.filter(i=>i.source_tier==="Officiell").length,t=U.filter(i=>i.source_tier==="Community").length,r=U.filter(i=>i.source_tier==="Sekundär").length;return`
    <div class="grid">
      <section class="card span-12">
  ...
  `}function De(){if(!l)return"";const e=jt(l),t=e[l.currentIndex];if(!t)return"";const r=l.endsAt-Date.now(),i=Object.keys(l.answers).length,n=l.answers[t.id]||"";return`
  ...
  `}function Le(){if(!h)return"";const e=h.sectionResults.length===0?"":`
  ...
  `}function Ae(){switch(E){case"overview":return wt();case"tracks":return $e();case"bank":return Me();case"mock":return Ie();case"research":return Pe();case"logic":return Te();default:return wt()}}function k(){const e=F();Y.innerHTML=`
    <div class="app">
      <header class="hero">
        <div class="hero-top">
          <div>
          ...
          <div class="hero-actions">
            ...
            <details class="mini-menu context-menu">
              <summary>${lt[E]}</summary>
              <div class="mini-menu-body">
                ${Object.entries(lt).map(([t,r])=>`<button class="secondary ${E===t?"active":""}" data-view="${t}">${r}</button>`).join("")}
            ...
            <details class="mini-menu user-menu">
              <summary class="user-avatar" title="Byt användare">
                ...
                <span class="user-avatar-initial">${ie(P)}</span>
              </summary>
              <div class="mini-menu-body">
                <p class="muted">Aktiv: ${P}</p>
  ...
  `}Y.addEventListener("click",e=>{const t=e.target,r=t.closest("button[data-view]");if(r){E=r.dataset.view,k();return}const i=t.closest("[data-action]");if(!i)return;const n=i.dataset.action;if(n){if(n==="export-progress"){ke();return}if(n==="start-today-drill"){const a=Ft(),o=F(),c=Number.parseInt(f.sessionPreference,10);D("Drill",a.map(u=>u.id),Number.isNaN(c)?o.totalMinutes:Math.max(30,Math.min(45,c)));return}if(n==="focus-priority-track"){const a=i.dataset.track;E="bank",v={trackId:a,topic:"all",difficulty:"all",sourceTier:"all"},$(`${S(a)} vald. Starta när du vill.`),k();return}if(n==="generate-ux-case"){Ot=ce(),k();return}if(n==="start-logic-drill"){const a=Ct();D("Drill",a.slice(0,12).map(o=>o.id),C(a));return}if(n==="start-track-drill"){const a=i.dataset.track,o=_.filter(c=>c.track_id===a).slice(0,8).map(c=>c.id);D("Drill",o,C(_.filter(c=>o.includes(c.id))));return}if(n==="start-track-learn"){const a=i.dataset.track,o=_.filter(c=>c.track_id===a).slice(0,6).map(c=>c.id);D("Lär",o,20);return}if(n==="open-python-course"){window.location.href="python-minikurs.html";return}if(n==="start-drill"){const a=Pt(_,v);D("Drill",a.slice(0,12).map(o=>o.id),C(a));return}if(n==="start-mock"){const a=L.find(c=>c.id===Q);if(!a)return;const o=a.sections.flatMap(c=>c.question_ids);D("Tidsprov",o,a.total_minutes,a.id);return}if(n==="save-profile"){le(f),$("Intervju sparad. Rekommenderad plan uppdaterad.");return}if(n==="quick-switch-user"){const a=window.prompt("Ange user id (t.ex. martin, sara, klass-a):",P);if(a===null)return;Z(a);return}if(n==="quick-switch-guest"){Z("gäst");return}if(n==="quick-generate-user"){const a=re();Z(a);return}if(l){if(n==="prev-q"){l.currentIndex=Math.max(0,l.currentIndex-1),A(l),k();return}if(n==="next-q"){l.currentIndex=Math.min(l.questionIds.length-1,l.currentIndex+1),A(l),k();return}if(n==="submit-session"){ht(!1);return}if(n==="cancel-session"){Se();return}if(n==="answer"){const a=t,o=a.dataset.qid;if(!o)return;l.answers[o]=a.value,A(l),k()}}}});Y.addEventListener("input",e=>{const t=e.target,r=t.closest("[data-profile]");if(r){const o=r.dataset.profile;o&&(t instanceof HTMLTextAreaElement||t instanceof HTMLSelectElement||t instanceof HTMLInputElement)&&(f={...f,[o]:t.value});return}const i=t.closest("textarea[data-action='answer-text']");if(i&&l){const o=i.dataset.qid;o&&(l.answers[o]=i.value,A(l));return}const n=t.closest("select[data-filter]");if(n){const o=n.dataset.filter;v={...v,[o]:n.value},k();return}const a=t.closest("select[data-mock-select='true']");a&&(Q=a.value,k())});Y.addEventListener("change",e=>{const r=e.target.closest("input[data-input='import-progress']");if(!r||!r.files||r.files.length===0)return;const[i]=r.files;ve(i),r.value=""});window.addEventListener("online",()=>{ft=!0,k()});window.addEventListener("offline",()=>{ft=!1,k()});he();be();xe();l&&Date.now()>=l.endsAt?ht(!0):(vt(),k());
